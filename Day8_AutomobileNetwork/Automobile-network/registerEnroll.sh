...
function createManufacturer() {
  ...
  set -x
  fabric-ca-client enroll -u https://peer0:peer0pw@localhost:7054 --caname ca-manufacturer -M ${PWD}/organizations/peerOrganizations/manufacturer.auto.com/peers/peer0.manufacturer.auto.com/msp --csr.hosts peer0.manufacturer.auto.com --tls.certfiles ${PWD}/organizations/fabric-ca/manufacturer/tls-cert.pem
  { set +x; } 2>/dev/null
  ...
  cp ${PWD}/organizations/peerOrganizations/manufacturer.auto.com/peers/peer0.manufacturer.auto.com/tls/tlscacerts/* ${PWD}/organizations/peerOrganizations/manufacturer.auto.com/msp/tlscacerts/ca.crt

  mkdir -p ${PWD}/organizations/peerOrganizations/manufacturer.auto.com/tlsca
  cp ${PWD}/organizations/peerOrganizations/manufacturer.auto.com/peers/peer0.manufacturer.auto.com/tls/tlscacerts/* ${PWD}/organizations/peerOrganizations/manufacturer.auto.com/tlsca/tlsca.manufacturer.auto.com-cert.pem

  mkdir -p ${PWD}/organizations/peerOrganizations/manufacturer.auto.com/ca
  cp ${PWD}/organizations/peerOrganizations/manufacturer.auto.com/peers/peer0.manufacturer.auto.com/msp/cacerts/* ${PWD}/organizations/peerOrganizations/manufacturer.auto.com/ca/ca.manufacturer.auto.com-cert.pem

  echo "Generating the user msp"
  set -x
  fabric-ca-client enroll -u https://user1:user1pw@localhost:7054 --caname ca-manufacturer -M ${PWD}/organizations/peerOrganizations/manufacturer.auto.com/users/User1@manufacturer.auto.com/msp --tls.certfiles ${PWD}/organizations/fabric-ca/manufacturer/tls-cert.pem
  { set +x; } 2>/dev/null
  ...
  set -x
  fabric-ca-client enroll -u https://manufactureradmin:manufactureradminpw@localhost:7054 --caname ca-manufacturer -M ${PWD}/organizations/peerOrganizations/manufacturer.auto.com/users/Admin@manufacturer.auto.com/msp --tls.certfiles ${PWD}/organizations/fabric-ca/manufacturer/tls-cert.pem
  { set +x; } 2>/dev/null
...
function createDealer() {
  ...
  echo "Generating the peer0 msp"
  set -x
  fabric-ca-client enroll -u https://peer0:peer0pw@localhost:8054 --caname ca-dealer -M ${PWD}/organizations/peerOrganizations/dealer.auto.com/peers/peer0.dealer.auto.com/msp --csr.hosts peer0.dealer.auto.com --tls.certfiles ${PWD}/organizations/fabric-ca/dealer/tls-cert.pem
  { set +x; } 2>/dev/null
  ...
  echo "Generating the peer0-tls certificates"
  set -x
  fabric-ca-client enroll -u https://peer0:peer0pw@localhost:8054 --caname ca-dealer -M ${PWD}/organizations/peerOrganizations/dealer.auto.com/peers/peer0.dealer.auto.com/tls --enrollment.profile tls --csr.hosts peer0.dealer.auto.com --csr.hosts localhost --tls.certfiles ${PWD}/organizations/fabric-ca/dealer/tls-cert.pem
  { set +x; } 2>/dev/null
  ...
  cp ${PWD}/organizations/peerOrganizations/dealer.auto.com/peers/peer0.dealer.auto.com/tls/tlscacerts/* ${PWD}/organizations/peerOrganizations/dealer.auto.com/msp/tlscacerts/ca.crt

  mkdir -p ${PWD}/organizations/peerOrganizations/dealer.auto.com/tlsca
  cp ${PWD}/organizations/peerOrganizations/dealer.auto.com/peers/peer0.dealer.auto.com/tls/tlscacerts/* ${PWD}/organizations/peerOrganizations/dealer.auto.com/tlsca/tlsca.dealer.auto.com-cert.pem

  mkdir -p ${PWD}/organizations/peerOrganizations/dealer.auto.com/ca
  cp ${PWD}/organizations/peerOrganizations/dealer.auto.com/peers/peer0.dealer.auto.com/msp/cacerts/* ${PWD}/organizations/peerOrganizations/dealer.auto.com/ca/ca.dealer.auto.com-cert.pem

  echo "Generating the user msp"
  set -x
  fabric-ca-client enroll -u https://user1:user1pw@localhost:8054 --caname ca-dealer -M ${PWD}/organizations/peerOrganizations/dealer.auto.com/users/User1@dealer.auto.com/msp --tls.certfiles ${PWD}/organizations/fabric-ca/dealer/tls-cert.pem
  { set +x; } 2>/dev/null
  ...
  echo "Generating the org admin msp"
  set -x
  fabric-ca-client enroll -u https://dealeradmin:dealeradminpw@localhost:8054 --caname ca-dealer -M ${PWD}/organizations/peerOrganizations/dealer.auto.com/users/Admin@dealer.auto.com/msp --tls.certfiles ${PWD}/organizations/fabric-ca/dealer/tls-cert.pem
  { set +x; } 2>/dev/null
...
function createMvd {
  ...
  set -x
  fabric-ca-client enroll -u https://admin:adminpw@localhost:11054 --caname ca-mvd --tls.certfiles ${PWD}/organizations/fabric-ca/mvd/tls-cert.pem
  { set +x; } 2>/dev/null
  ...
  OrdererOUIdentifier:
	...
	echo "Registering peer0"
  set -x
	fabric-ca-client register --caname ca-mvd --id.name peer0 --id.secret peer0pw --id.type peer --tls.certfiles ${PWD}/organizations/fabric-ca/mvd/tls-cert.pem
  { set +x; } 2>/dev/null
  ...
  echo "Generating the peer0 msp"
  set -x
	fabric-ca-client enroll -u https://peer0:peer0pw@localhost:11054 --caname ca-mvd -M ${PWD}/organizations/peerOrganizations/mvd.auto.com/peers/peer0.mvd.auto.com/msp --csr.hosts peer0.mvd.auto.com --tls.certfiles ${PWD}/organizations/fabric-ca/mvd/tls-cert.pem
  { set +x; } 2>/dev/null
  ...
  echo "Generating the peer0-tls certificates"
  set -x
  fabric-ca-client enroll -u https://peer0:peer0pw@localhost:11054 --caname ca-mvd -M ${PWD}/organizations/peerOrganizations/mvd.auto.com/peers/peer0.mvd.auto.com/tls --enrollment.profile tls --csr.hosts peer0.mvd.auto.com --csr.hosts localhost --tls.certfiles ${PWD}/organizations/fabric-ca/mvd/tls-cert.pem
  { set +x; } 2>/dev/null
  ...
  mkdir ${PWD}/organizations/peerOrganizations/mvd.auto.com/msp/tlscacerts
  cp ${PWD}/organizations/peerOrganizations/mvd.auto.com/peers/peer0.mvd.auto.com/tls/tlscacerts/* ${PWD}/organizations/peerOrganizations/mvd.auto.com/msp/tlscacerts/ca.crt

  mkdir ${PWD}/organizations/peerOrganizations/mvd.auto.com/tlsca
  cp ${PWD}/organizations/peerOrganizations/mvd.auto.com/peers/peer0.mvd.auto.com/tls/tlscacerts/* ${PWD}/organizations/peerOrganizations/mvd.auto.com/tlsca/tlsca.mvd.auto.com-cert.pem

  mkdir ${PWD}/organizations/peerOrganizations/mvd.auto.com/ca
  cp ${PWD}/organizations/peerOrganizations/mvd.auto.com/peers/peer0.mvd.auto.com/msp/cacerts/* ${PWD}/organizations/peerOrganizations/mvd.auto.com/ca/ca.mvd.auto.com-cert.pem

  echo "Generating the user msp"
  set -x
	fabric-ca-client enroll -u https://user1:user1pw@localhost:11054 --caname ca-mvd -M ${PWD}/organizations/peerOrganizations/mvd.auto.com/users/User1@mvd.auto.com/msp --tls.certfiles ${PWD}/organizations/fabric-ca/mvd/tls-cert.pem
  { set +x; } 2>/dev/null
  ...
  echo "Generating the org admin msp"
  set -x
	fabric-ca-client enroll -u https://mvdadmin:mvdadminpw@localhost:11054 --caname ca-mvd -M ${PWD}/organizations/peerOrganizations/mvd.auto.com/users/Admin@mvd.auto.com/msp --tls.certfiles ${PWD}/organizations/fabric-ca/mvd/tls-cert.pem
  { set +x; } 2>/dev/null
...
function createOrderer() {
  ...
  set -x
  fabric-ca-client enroll -u https://orderer:ordererpw@localhost:9054 --caname ca-orderer -M ${PWD}/organizations/ordererOrganizations/auto.com/orderers/orderer.auto.com/msp --csr.hosts orderer.auto.com --csr.hosts localhost --tls.certfiles ${PWD}/organizations/fabric-ca/ordererOrg/tls-cert.pem
  { set +x; } 2>/dev/null
  ...
  set -x
  fabric-ca-client enroll -u https://orderer:ordererpw@localhost:9054 --caname ca-orderer -M ${PWD}/organizations/ordererOrganizations/auto.com/orderers/orderer.auto.com/tls --enrollment.profile tls --csr.hosts orderer.auto.com --csr.hosts localhost --tls.certfiles ${PWD}/organizations/fabric-ca/ordererOrg/tls-cert.pem
  { set +x; } 2>/dev/null
  ...
  cp ${PWD}/organizations/ordererOrganizations/auto.com/orderers/orderer.auto.com/tls/tlscacerts/* ${PWD}/organizations/ordererOrganizations/auto.com/msp/tlscacerts/tlsca.auto.com-cert.pem

  echo "Generating the admin msp"
  set -x
  fabric-ca-client enroll -u https://ordererAdmin:ordererAdminpw@localhost:9054 --caname ca-orderer -M ${PWD}/organizations/ordererOrganizations/auto.com/users/Admin@auto.com/msp --tls.certfiles ${PWD}/organizations/fabric-ca/ordererOrg/tls-cert.pem
  { set +x; } 2>/dev/null
